...
class Preprocess_covid_tweets_dataset(object):
    ...
    def preprocess_covid_tweets(self, dataset):
        ...
        # Preprocess sentences (VECTORIZE THIS CODE)
        ...
        # Perform conjunction analysis on sentences (VECTORIZE THIS CODE)
        dataset = self.conjunction_analysis(dataset)
        
        # Create rule masks (VECTORIZE THIS CODE)
