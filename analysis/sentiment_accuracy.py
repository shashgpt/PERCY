...
class Sentiment_accuracy(object):
    ...
    def calculate_mean_std(self, base_sentiment_corrects, mask_sentiment_corrects, mask_contrast_sentiment_corrects):

        distributions_overall = [base_sentiment_corrects['overall'], mask_sentiment_corrects['overall'], mask_contrast_sentiment_corrects['overall']]

        distributions_no_rule = [base_sentiment_corrects['no_rule'], mask_sentiment_corrects['no_rule'], mask_contrast_sentiment_corrects['no_rule']]

        distributions_one_rule = [base_sentiment_corrects['one_rule'], mask_sentiment_corrects['one_rule'], mask_contrast_sentiment_corrects['one_rule']]
        distributions_one_rule_contrast = [base_sentiment_corrects['one_rule_contrast'], mask_sentiment_corrects['one_rule_contrast'], mask_contrast_sentiment_corrects['one_rule_contrast']]
        distributions_one_rule_no_contrast = [base_sentiment_corrects['one_rule_no_contrast'], mask_sentiment_corrects['one_rule_no_contrast'], mask_contrast_sentiment_corrects['one_rule_no_contrast']]

        distributions_a_but_b = [base_sentiment_corrects['a_but_b'], mask_sentiment_corrects['a_but_b'], mask_contrast_sentiment_corrects['a_but_b']]
        distributions_a_but_b_contrast = [base_sentiment_corrects['a_but_b_contrast'], mask_sentiment_corrects['a_but_b_contrast'], mask_contrast_sentiment_corrects['a_but_b_contrast']]
        distributions_a_but_b_no_contrast = [base_sentiment_corrects['a_but_b_no_contrast'], mask_sentiment_corrects['a_but_b_no_contrast'], mask_contrast_sentiment_corrects['a_but_b_no_contrast']]

        distributions_a_yet_b = [base_sentiment_corrects['a_yet_b'], mask_sentiment_corrects['a_yet_b'], mask_contrast_sentiment_corrects['a_yet_b']]
        distributions_a_yet_b_contrast = [base_sentiment_corrects['a_yet_b_contrast'], mask_sentiment_corrects['a_yet_b_contrast'], mask_contrast_sentiment_corrects['a_yet_b_contrast']]
        distributions_a_yet_b_no_contrast = [base_sentiment_corrects['a_yet_b_no_contrast'], mask_sentiment_corrects['a_yet_b_no_contrast'], mask_contrast_sentiment_corrects['a_yet_b_no_contrast']]

        distributions_a_though_b = [base_sentiment_corrects['a_though_b'], mask_sentiment_corrects['a_though_b'], mask_contrast_sentiment_corrects['a_though_b']]
        distributions_a_though_b_contrast = [base_sentiment_corrects['a_though_b_contrast'], mask_sentiment_corrects['a_though_b_contrast'], mask_contrast_sentiment_corrects['a_though_b_contrast']]
        distributions_a_though_b_no_contrast = [base_sentiment_corrects['a_though_b_no_contrast'], mask_sentiment_corrects['a_though_b_no_contrast'], mask_contrast_sentiment_corrects['a_though_b_no_contrast']]

        distributions_a_while_b = [base_sentiment_corrects['a_while_b'], mask_sentiment_corrects['a_while_b'], mask_contrast_sentiment_corrects['a_while_b']]
        distributions_a_while_b_contrast = [base_sentiment_corrects['a_while_b_contrast'], mask_sentiment_corrects['a_while_b_contrast'], mask_contrast_sentiment_corrects['a_while_b_contrast']]
        distributions_a_while_b_no_contrast = [base_sentiment_corrects['a_while_b_no_contrast'], mask_sentiment_corrects['a_while_b_no_contrast'], mask_contrast_sentiment_corrects['a_while_b_no_contrast']]
        ...
        data_means_std = {"base_model":{"overall":[correct_means_overall[0], correct_std_overall[0]], 
                            ...
                            "mask_model":{"overall":[correct_means_overall[1], correct_std_overall[1]], 
                            ...
                            "mask_contrast_model":{"overall":[correct_means_overall[2], correct_std_overall[2]], 
                                                "no_rule":[correct_means_no_rule[2], correct_std_no_rule[2]], 
                                                "one_rule":[correct_means_one_rule[2], correct_std_one_rule[2]],
