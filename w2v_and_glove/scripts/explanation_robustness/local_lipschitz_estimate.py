...
class Local_lipschitz_estimate(object):
    ...
    def lime_explanations_estimates(self, word_index):
        ...
        with open("assets/lime_explanations/"+self.config["asset_name"]+".pickle", "rb") as handle:
            ...
            if "features" in explanations.keys() and len(explanations["features"])==0:
                explanations.pop('features', None)
    ...
    def shap_explanations_estimates(self, word_index):
    ...
    def int_grad_explanations_estimates(self, word_index):
